...
<head>
<title>A_View_Vehicle_Type_Results </title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>View Vehicle Type Results </span></h2>
          <div class="clr"></div>
          <div class="post_content1">
            <p align="justify">&nbsp;</p>
            <p align="justify">	
              
              <iframe src="Results3.jsp" width="610" height="500"></iframe></br>
            </p>
            <p align="justify">Note --- <span class="style3">Empty Bar -- Unknown Vechicle </span></p>
          </div>
          <div class="clr"></div>
